const BASE_ICONS_URL = "/assets/logos";
...
const logos = {
  ...
  zustand: { src: `${BASE_ICONS_URL}/zustand.svg`, alt: "zustand" },
  pwa: { src: `${BASE_ICONS_URL}/pwa.svg`, alt: "pwa" },
  twa: { src: `${BASE_ICONS_URL}/twa.svg`, alt: "twa" },
  git: { src: `${BASE_ICONS_URL}/git.svg`, alt: "git" },
  html: { src: `${BASE_ICONS_URL}/html.svg`, alt: "html" },
